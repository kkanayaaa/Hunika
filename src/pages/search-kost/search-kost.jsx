export default function SearchKost() {
  const kostList = [
    ...
    { img: "/images-hunika/2.jpg", name: "Kost Bintaro Indah", loc: "Jakarta Selatan - Bintaro", price: "1.500.000" },
    { img: "/images-hunika/3.jpg", name: "Kost Mawar Kemang", loc: "Jakarta Selatan - Kemang", price: "1.100.000" },
    { img: "/images-hunika/4.jpg", name: "Kost Casabella", loc: "Jakarta Selatan - Pondok Indah", price: "2.000.000" },
    { img: "/images-hunika/5.jpg", name: "Kost Green", loc: "Jakarta Selatan - Cipete", price: "900.000" },
    { img: "/images-hunika/6.jpg", name: "Kost Pesanggarahan Indah", loc: "Jakarta Selatan - Pesanggarahan", price: "1.800.000" },
    { img: "/images-hunika/7.jpg", name: "Kost Tebet Hijau", loc: "Jakarta Selatan - Tebet", price: "1.600.000" },
    { img: "/images-hunika/8.jpg", name: "Kost Mama", loc: "Jakarta Selatan - Mampang", price: "1.000.000" },
    { img: "/images-hunika/9.jpg", name: "Kost Harmonika", loc: "Jakarta Selatan - Fatmawati", price: "1.300.000" },
    { img: "/images-hunika/10.jpg", name: "Kost Senara", loc: "Jakarta Selatan - Senopati", price: "1.200.000" },
    { img: "/images-hunika/11.jpg", name: "Kost Gandaria City", loc: "Jakarta Selatan - Gandaria", price: "2.400.000" },
    { img: "/images-hunika/12.jpg", name: "Kost Setia", loc: "Jakarta Selatan - Setiabudi", price: "2.100.000" },
  ];
    ...
    <div className="bg-slate-100 min-h-screen">
      ...
      <section className="text-center py-16 px-5">
        ...
        <div className="flex justify-center gap-3">
          <input
            ...
            className="w-[500px] p-3 border border-gray-300 rounded-lg"
          />
      ...
      <div className="flex gap-6 px-10 pb-10">
        ...
        <aside className="w-64 self-start bg-white rounded-2xl shadow-md border border-gray-100 p-5">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2 text-gray-600">
              {["Standar", "Deluxe", "Eksklusif", "All"].map((item) => (
                <label key={item} className="flex items-center gap-2">
                  <input type="radio" name="tipe" /> {item}
                </label>
              ))}
            </div>
          </div>
          ...
          <button className="w-full bg-gray-100 hover:bg-gray-200 py-3 rounded-full">
            ↺ Reset Filter
          </button>
        </aside>
            ...
            {kostList.map((kost, i) => (
              <div key={i} className="bg-white rounded-xl overflow-hidden shadow-md">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-500 mb-2">📍 {kost.loc}</p>
